...
# 背景：品牌蓝 #2563eb
$bgBrush = New-Object System.Drawing.SolidBrush([System.Drawing.Color]::FromArgb(124, 58, 237))
...
$g.DrawString('AI 标识卫士', $fontTitle, $white, 84.0, 205.0)

$fontSub = New-Object System.Drawing.Font('Microsoft YaHei', 26)
$g.DrawString('为 AI 生成图片一键添加标识', $fontSub, $white, 88.0, 330.0)
...
$g.DrawString('显式+隐式双标识 · 本地处理 · 免费', $fontTag, $tagBrush, 90.0, 405.0)
